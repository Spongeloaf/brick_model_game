...
public static class PawnUtils
{
    ...
    public static class Combat
    {
        ...
        private static void CalculateSkillCheckValues(PawnController actor, int useModifier, ref SkillCheck.Parameters skill)
        {
            ...
            // Fix this one you figure out the new weapon system!
        ...
        public static float GetProjectileDirectFlightTime(in Vector3 from, in Vector3 to, in float speed)
        {
            ...
            if (speed < 0)
            {
                OmniLogger.Error("GetProjectileDirectFlightTime() got a negative speed!");
                return result;
            }
            ...
            if (result > Globals.projectileMaxDistance / Globals.slowestProjectileSpeed)
            {
                OmniLogger.Error("GetProjectileDirectFlightTime() somehow got a result that is too long!");
                result = Globals.maxProjectileFlightTime;
            }
